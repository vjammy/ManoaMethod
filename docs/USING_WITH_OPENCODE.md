...
Use this guide if you want to run a Xelera Method workspace with OpenCode.
...
- `.tmp-family-task-app/xelera-method-workspace/OPENCODE_START_HERE.md`
...
`dist-addons/opencode/xelera-method/`
